                            ...
                            <?php foreach ($result as $data): ?>
                                <div class="article-card">
                                    ...
                                    <div class="card-meta">
                                        ...
                                        <a class="text-secondary" href="<?php echo $url."uploads/".$data['attachment'];?>" target="_blank">Download Book</a>
                                        <?php }?>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <span class="post-date">
                                            Published on : <?php echo date('d M Y', strtotime($data['publish_date'])); ?>
                                        </span>
                                    </div>
                                </div>
                            <?php endforeach; ?>
